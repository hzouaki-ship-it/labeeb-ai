...
# =========================================
# قاعدة البيانات المعجمية (الكلمات الدالة والقرائن)
# =========================================
semantic_db = {
    "عين": [
        {"المعنى": "عضو البصر والرؤية", "القرائن": ["طفل", "أصيب", "بصر", "طبيب", "نظارات", "رؤية", "دمع", "جندي", "فقد", "العين", "عينه", "عينها", "مستشفى"]},
        {"المعنى": "نبع ماء طبيعي", "القرائن": ["ماء", "شرب", "عذب", "واحة", "بئر", "تدفق", "نبع", "صحراء", "جداول", "ساقية"]},
        {"المعنى": "جاسوس ومراقب سري", "القرائن":
