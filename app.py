...
# 1. إعدادات الصفحة الأساسية لضمان الهوية الأكاديمية للمنصة
st.set_page_config(
...
# 2. هندسة الـ CSS المتقدمة وفرض الاتجاه العربي (RTL) الشامل والتراصف
st.markdown("""
<style>
@import url('https://fonts.googleapis.com/css2?family=Cairo:wght@300;400;600;700;800&display=swap');

/* فرض الاتجاه العربي من اليمين إلى اليسار على التطبيق بالكامل وبشكل قطعي */
...
/* تحديد أبعاد الحاوية الرئيسية للمنصة */
...
/* إلغاء الفراغات والحدود الافتراضية المزعجة من ستريمليت */
...
/* ---------------- حالة الانتظار (لم يتم إجراء أي تحليل) ---------------- */
.inner-dashed-box {
...
/* ---------------- بطاقات الأيقونات الأفقية المحدثة ---------------- */
